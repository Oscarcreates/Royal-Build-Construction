    ...
    try {
      const res = await fetch(CONTACT_ENDPOINT, {
        ...
        body: JSON.stringify({
          ...
          // Bundle service + message into the message field
          // since the endpoint only reads name, email, message
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                <div className="bg-sky-50 rounded-2xl p-4 border border-sky-100">
                  ...
                  <div className="text-sky-600 font-bold text-sm">info@royal <span>buildconstruction.com</span></div>
                </div>
              </div>
            </div>
          </FadeIn>
